...
const NewPost = ({ theme, toggleTheme }) => {
    ...
    return (
        <div className={`${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'} flex flex-col md:flex-row h-screen transition-colors duration-300`}>
            ...
            <div className="w-full">
                ...
                <div className="p-4">
                    <div className={`${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} p-6 rounded-lg shadow-md transition-colors duration-300`}>
