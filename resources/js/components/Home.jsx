      ...
      <div className="flex flex-col min-h-screen bg-gray-800 text-white">
        <nav className="flex justify-between items-center py-4 px-8 m-4">
          ...
          <div className="hidden md:flex items-center">
            <a href="#home" className="text-lg font-semibold ml-4">
              Home
            </a>
            <a href="#features" className="text-lg font-semibold ml-4">
              Fonctionnalités
            </a>
            <Link to="/profil" className="text-lg font-semibold ml-4">
              Candidat ?
            </Link>
          ...
          <button onClick={toggleModal} className="hidden md:block text-lg font-semibold ml-4 border border-white px-4 py-2 rounded-lg">
            Contact
          </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden flex flex-col items-center bg-gray-800 py-4">
            <a href="#home" className="text-lg font-semibold mb-2">
              Home
            </a>
            <a href="#features" className="text-lg font-semibold mb-2">
              Fonctionnalités
            </a>
            <Link to="/profil" className="text-lg font-semibold mb-2">
              Candidat ?
            </Link>
            <a href="#about" className="text-lg font-semibold mb-2">
              À propos de nous
            </a>
